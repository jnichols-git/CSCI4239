...
void main()
{
  float x_pos = ndc.x * ratio;
  //  Generate spatial coordinate from ndc
  float r = sqrt(1-(x_pos*x_pos));
  // Alter brick size according to position in ndc
  vec2 RadSize = BrickSize*r;
